...
#
for my $key (qw(GET CALL SET DEFAULT INSERT INCLUDE PROCESS WRAPPER IF UNLESS
    ...
    like(
        warning { template_toolkit( \$template, { $key => 1 } ) },
        qr/^clashes with reserved Template Toolkit word$/,
